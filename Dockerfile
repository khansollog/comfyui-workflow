...
RUN wget --progress=dot:giga -O '/comfyui/input/ComfyUI_temp_ljpig_00008_.png' "https://cool-anteater-319.convex.cloud/api/storage/0f74be1a-7e07-42db-99db-c6eb99a542ae"
RUN wget --progress=dot:giga -O '/comfyui/input/ComfyUI_temp_zmuag_00002_.png' "https://cool-anteater-319.convex.cloud/api/storage/c45a9e9f-0e68-4f22-a3d9-ab57c5e68b93"
